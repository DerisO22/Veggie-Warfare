export const playerQueries = {
    ...
    UPSERT_PLAYER_KEYBINDS:
        `INSERT INTO player_keybinds (clerk_user_id, forward, backward, "left", "right", jump, ability1, ability2, ability3)
        VALUES ($1, $2, $3, $4, $5, $6, $7, $8, $9)
        ON CONFLICT (clerk_user_id)
        DO UPDATE SET forward = $2, backward = $3, "left" = $4, "right" = $5, jump = $6, ability1 = $7, ability2 = $8, ability3 = $9
        RETURNING *;`,
